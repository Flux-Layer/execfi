  ...
  const quests = [
    {
      ...
      difficulty: "EASY",
      requirements: { transactionType: "transfer", minTransactions: 3, minAmount: "0.00001" },
      baseXpReward: 80,
      estimatedTime: 10,
      isActive: true,
    },
    {
      ...
      questType: "TRANSACTION",
      difficulty: "EASY",
      requirements: { transactionType: "contract_call", minTransactions: 5 },
      baseXpReward: 90,
      estimatedTime: 12,
      isActive: true,
    },
    {
      ...
      questType: "TRANSACTION",
      difficulty: "MEDIUM",
      requirements: { transactionType: "swap", minTransactions: 1 },
      baseXpReward: 150,
      estimatedTime: 15,
      isActive: true,
    },
    {
      ...
      difficulty: "HARD",
      requirements: { transactionType: "contract_call", minTransactions: 10, timeLimit: 86400 },
      baseXpReward: 500,
      estimatedTime: 25,
      isActive: true,
    },
    {
      ...
      difficulty: "EASY",
      requirements: { transactionType: "game_play", minScore: 10 },
      baseXpReward: 120,
      estimatedTime: 15,
      isActive: false,
    },
    {
      ...
      questType: "TRANSACTION",
      difficulty: "MEDIUM",
      requirements: { transactionType: "vault_deposit", minAmount: "0.01" },
      baseXpReward: 200,
      estimatedTime: 10,
      isActive: false,
    },
    {
      ...
      questType: "ACHIEVEMENT",
      difficulty: "HARD",
      requirements: { transactionType: "contract_call", minTransactions: 5, maxGasUsed: 50000 },
      baseXpReward: 300,
      estimatedTime: 20,
      isActive: false,
    },
    {
      ...
      questType: "TRANSACTION",
      difficulty: "MEDIUM",
      requirements: { transactionType: "bridge", minAmount: "0.001" },
      baseXpReward: 250,
      estimatedTime: 15,
      isActive: false,
    },
    {
      ...
      questType: "EXPLORATION",
      difficulty: "EPIC",
      requirements: { transactionType: "multi_game", gameCount: 3 },
      baseXpReward: 600,
      estimatedTime: 30,
      isActive: false,
    },
    {
      ...
      questType: "ACHIEVEMENT",
      difficulty: "EPIC",
      requirements: { transactionType: "complete_all", timeLimit: 86400 },
      baseXpReward: 1000,
      estimatedTime: 60,
      isActive: false,
    },
