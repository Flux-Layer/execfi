                                                ...
                                                >
                                                   {privyWallets.map((wallet, index) => (
                                                      <motion.button
                                                         ...
                                                         className={`w-full p-3 text-left hover:bg-white/10 transition-colors border-b border-white/5 last:border-b-0 ${selectedWalletIndex === index
                                                               ? "bg-purple-500/20"
                                                               : ""
                                                            }`}
                                                         whileHover={{ x: 4 }}
                                                      ...
                                                      >
                                                         <div className="flex items-center gap-3">
                                                            <div
                                                               className={`w-2 h-2 rounded-full ${selectedWalletIndex === index
                                                                     ? "bg-purple-500"
                                                                     : "bg-gray-600"
                                                                  }`}
                                                            />
