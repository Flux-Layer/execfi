    ...
    <div className="pointer-events-none">
      ...
      >
        <div
          ...
          className={
            effectiveFullscreen
              ? "pointer-events-auto relative flex h-full w-full flex-col overflow-hidden bg-slate-950/95 font-mono md:h-[calc(95vh-4rem)] md:w-[calc(100vw-4rem)] md:rounded-2xl md:border md:border-slate-800 md:shadow-2xl md:shadow-black/50"
              : "pointer-events-auto relative flex h-[32rem] w-full max-w-4xl flex-col overflow-hidden rounded-2xl border border-slate-900 bg-slate-950/95 font-mono shadow-2xl shadow-black/60"
          }
        >
          <TerminalHeader
